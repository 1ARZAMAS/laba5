...
const int MAX_CELLS = 6000; // Максимальное количество ячеек
const int NUM_ZONES = 3;
const int NUM_SHELVES_PER_ZONE = 20;
const int NUM_SECTIONS_PER_SHELF = 5;
const int NUM_SHELVES_PER_SECTION = 2;
